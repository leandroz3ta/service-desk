<?php 
  ...
  */session_start();
	...
	$linhasInst = mysqli_num_rows($resultadoInst);	
		...
		//Monta o cabe�alho do quadro de estat�stica
		print "<TABLE border='0' cellpadding='5' cellspacing='0' align='left' width='80%' bgcolor='".$cor3."'>";
			...
			print "<td rowspan='100%' ><div id='Layer2'>";//  <!-- Ver: overflow: auto    n�o funciona para o Mozilla-->
			...
			while ($rowAux = mysqli_fetch_array($resultadoAux)) {
				...
				//Monsta os percentuais de cada tipo de equipamento de acordo com a sua situa��o
				...
				while ($row = mysqli_fetch_array($resultado)) {
					...
					print "<TD bgcolor='".$color."'><a href='mostra_consulta_comp.php?comp_situac=".$row['situac_cod']."&ordena=local,etiqueta' title='Exibe a listagem dos equipamentos cadastrados nessa situa��o.'>".$row['situacao']."</a></TD>";
