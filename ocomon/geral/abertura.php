...
session_start();
  ...
  */
	...
	if ($linhas == 0) {
		...
		print "<table class='header_centro'  border='0' cellpadding='5' cellspacing='0' align='center' width='100%'>";
		//" bgcolor='".$cor."'>";
		print "<TR class='header'>";
...
// 	$PAGE->execSQL();
        ...
        print "<TD  class='line' >";
        print "<TABLE class='header_centro' border='0' cellpadding='2' cellspacing='0' align='center' width='100%'>";  //cellpadding='2' cellspacing='0'
