...
if (!isset($_POST['ok']))
{
	...
	print "</head>";
	print "	<BR><BR>";
	print "	<B><center>::: ".TRANS('TTL_OPERATOR_AREA_ATTEND')." :::</center></B><BR><BR>";
